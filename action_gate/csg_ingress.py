...
def validate_timestamp(timestamp: datetime) -> None:
    ...
    if abs((utc_now() - timestamp).total_seconds()) > REQUEST_TTL_SKEW_SECONDS:
...
def build_decision(req: PermissionRequest, request_digest: str) -> DecisionObject:
    ...
    unsigned = {
        ...
        "tenant_id": req.tenant_id, "actor_id": req.actor_id, "session_id": req.session_id, "decision": decision, "risk_level": risk, "request_digest": request_digest,
